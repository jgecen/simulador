...
public class CommandJz implements CommandInstruction{
	public static final byte OP_CODE = (byte) 0xCA;
	public void execute(Simulator sim) {
		...
		if(sim.getFlagRegister().getZeroFlag() == 1){
